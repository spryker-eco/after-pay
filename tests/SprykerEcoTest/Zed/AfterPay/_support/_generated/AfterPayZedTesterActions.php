<?php  //[STAMP] bd494c59b84ea31bea9c8694c4b14679
namespace SprykerEcoTest\Zed\AfterPay\_generated;

// This class was automatically generated by build task
// You should not change it manually as it will be overwritten on next build
// @codingStandardsIgnoreFile

trait AfterPayZedTesterActions
{
    /**
     ...
     */
    public function haveProduct($productConcreteOverride = null, $productAbstractOverride = null) {
     ...
     */
    public function haveProductAbstract($productAbstractOverride = null) {
     ...
     */
    public function addLocalizedAttributesToProductAbstract($productAbstractTransfer, $localizedAttributes) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('addLocalizedAttributesToProductAbstract', func_get_args()));
    }
     ...
     */
    public function addLocalizedAttributesToProductConcrete($productConcreteTransfer, $localizedAttributes) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('addLocalizedAttributesToProductConcrete', func_get_args()));
    }
     ...
     */
    public function haveOrder($override = null, $stateMachineProcessName = null) {
